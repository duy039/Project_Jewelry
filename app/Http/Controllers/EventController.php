...
class EventController extends Controller
{
    ...
    public function eventEveryDay(){
        ...
        if (isset($_SESSION['user_id'])) {
            // đã login
            $loginevent = DB::table('loginevent')->where('User_id', $_SESSION['user_id'])->get();
    ...
    public function checkedEventEveryDay(){
        ...
        if (isset($_SESSION['user_id'])) {
            ...
            $user = DB::table('users')->where('id',$_SESSION['user_id'])->get();
            ...
            DB::table('users')->where('id',$_SESSION['user_id'])->update(array(
                'point'=>$pointToday,
            ));
            return true;
        }        
