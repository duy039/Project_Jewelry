...
@section('admin_content')
    <div class="col-md-12">
        <form action="{{ url('admin/addVoucher') }}" method="post" class="form-horizontal">
            {{ csrf_field() }}
            <div class="card">
                ...
                <div class="card-body ">
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                            <div class="form-group">
                                <input id="voucher_code" class="form-control" type="text" name="coupon_id"
                                    placeholder="{{ __('Enter voucher id') }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                            <div class="form-group">
                                <input class="form-control" type="text" name="coupon_name" class="form-control"
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                            <div class="form-group">
                                <input class="form-control" type="text" name="coupon_sale"
                                    placeholder="{{ __('Enter sale') }}">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                            <div class="form-group">
                                <input class="form-control" type="text" name="coupon_limited"
                                    placeholder="{{ __('Enter limited') }}">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                            <div class="form-group">
                                <input class="form-control" type="text" name="coupon_status"
                    ...
                    <div class="">
                        <center>
                            <button type="submit" class="btn btn-rose">{{ __('Add voucher') }}</button>
                        </center>
                    </div>
        </form>
    </div>
