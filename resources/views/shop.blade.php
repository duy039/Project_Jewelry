                                ...
                                <div class="price-filter">
                                    ...
                                    <div class="price-slider-amount">
                                        <div class="label-input">
                                            ...
                                            <table>
                                                <tr>
                                                    <td><h6 style="padding-top: 7px">From : </h6></td>
                                                    <td><input style="font-size: 15px; margin-left: 40px" type="number" id="priceFrom" name="priceFrom"></td>
                                                </tr>
                                                <tr>
                                                    <td><h6 style="padding-top: 7px">To : </h6></td> 
                                                    <td><input  style="font-size: 15px; margin-left: 40px" type="number" id="priceTo" name="priceTo"><br></td>
                                                </tr>
                                            </table>
                            ...
                            <div class="category-module hiraola-sidebar_categories">
                                ...
                                <div class="module-body">
                                    <ul class="module-list_item">
                                        <li>
                                            @foreach ($tags as $t)
                                                <a href='{{ url("shop/categories/".$t->getId()) }}'>{!! $t->getName() !!} ({{ count($t->getProduct_id()) }})</a>
                                            @endforeach
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <div class="sidebar-banner_area">
                            <div class="banner-item img-hover_effect">
                                <a href="javascript:void(0)">
                                    <img src="{{ url("assets/images/banner/pn_03.jpg") }}" alt="Hiraola's Shop Banner Image">
                                </a>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="single_product">
                                        <div class="product-img">
                                            ...
                                            <div class="add-actions">
                                                <ul>
                                                    ...
                                                    <li onclick="quickView('{!!$pro->getId()!!}')" class="quick-view-btn" data-toggle="modal" data-target="#exampleModalCenter">
                                        ...
                                        <div class="hiraola-product_content">
                                            <div class="product-desc_info">
                                                <h6>
                                                    <a class="product-name" href='{{url("/product". "/" .$pro->getId())}}'>{!! $pro->getName() !!}</a>
                                                </h6>
                                                <div class="price-box">
                                        ...
                                        <div class="hiraola-product_content">
                                            ...
                                            <div class="add-actions">
                                                <ul>
                                                    ...
                                                    <li onclick="quickView('{!!$pro->getId()!!}')" class="quick-view-btn" data-toggle="modal" data-target="#exampleModalCenter"><a href="javascript:void(0)" data-toggle="tooltip" data-placement="top" title="Quick View"><i
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-6">
                                            <ul id="numberPage" class="hiraola-pagination-box">
                                                <li><a class="Next" href="javascript:void(0)" onclick="backPage()"><i
