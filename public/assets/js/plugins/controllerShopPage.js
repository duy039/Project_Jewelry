            ...
            for(y=0; y < product.length; y++){
                if(y >= start && y < end){
                    ...
                    var str3 =              '<div class="add-actions">'
                            ...
                            +                       '</li>'
                            +                       '<li>'
                            +                           '<a class="hiraola-add_compare" href="javascript:void(0)" onclick="addProductCompare(\'' +product[y].Product_id+ '\')" data-toggle="tooltip" data-placement="top" title="Compare This Product">'
                    ...
                    var str33=                            '</li>'
                        ...
                        var str7 =                  '</ul>'
                            ...
                            +                       '<li><a class="hiraola-add_compare" href="javascript:void(0)" onclick="addProductCompare(\'' +product[y].Product_id+ '\')"  data-toggle="tooltip" data-placement="top" title="Compare This Product"><i class="ion-ios-shuffle-strong"></i></a></li>'
